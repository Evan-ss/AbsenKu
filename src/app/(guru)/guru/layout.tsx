...
function GuruLayoutContent({ children }: { children: React.ReactNode }) {
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center gap-3 px-6 border-b border-gray-200">
            ...
            <span className="font-semibold text-gray-900">AbsensiKu</span>
          </div>
          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-8 h-8 bg-amber-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                {session.user?.nama?.charAt(0)?.toUpperCase() || "G"}
              </div>
...
export default function GuruLayout({
  ...
  return <GuruLayoutContent>{children}</GuruLayoutContent>;
}
